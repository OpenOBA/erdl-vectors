...
| 验证层 | 类别 | 覆盖对象 | 数量 | 状态 |
|--------|------|---------|:---:|------|
| 审计层 | V-DO-v15 | 决策类型 13 / 链攻击 8 / 锚定 10 / 金丝雀 1 / 结论 14 / 法域 32 | 78 | 未验证 |
| 表达层 | V-ENGINE | 节点语义 136 + 求值约束 35 + Simple 编译 30 | 201 | 未验证 |
| 表达层 | V-GLOSS / V-PROJ | gloss 16（渲染 12 + 完整性 4）+ 投影面 6 | 22 | 未验证 |
| **合计** | | **Core** | **301** | **未验证** |
