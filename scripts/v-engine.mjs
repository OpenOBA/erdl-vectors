...
const CONSTRAINTS_DEFS = [
    ...
    // E11 null check asymmetry §7.3(a) (G4 regression lock): != null senses presence (true when present);
    // == null senses absence. null-on-left is fail-closed (both eq and ne false).
