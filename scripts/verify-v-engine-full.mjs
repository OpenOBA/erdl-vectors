...
/**
 * verify-v-engine-full.mjs — V-ENGINE full 233-vector verifier
 *
 ...
 *   - this file: full 233 coverage (34 nodes × 4 scenarios + E1-E12 constraints + Simple + gloss + projection)
...
console.log('  ✅ V-ENGINE 233 vectors full verification passed');
process.exit(0);
