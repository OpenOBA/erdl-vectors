...
/**
 * verify-v-engine-full.mjs — V-ENGINE full 240-vector verifier
 *
 ...
 *   - this file: full 240 coverage (34 nodes × 4 scenarios + E1-E12 constraints + Simple + gloss + projection)
...
console.log('  ✅ V-ENGINE 240 vectors full verification passed');
process.exit(0);
