 ...
 *
 * After migrating in scripts/generate-v-engine.mjs, generate 227 vectors with the @openoba/erdl reference engine,
...
describe('V-ENGINE generator (scripts/generate-v-engine.mjs)', () => {
  it('generates 227 and is byte-identical with the committed artifact', () => {
